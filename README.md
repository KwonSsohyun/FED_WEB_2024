...
| `11 week` | Day 23 | 24.09.19 | • 리액트 Tailwind CSS 적용 <br>• Tailwind 설정 및 사용방법 <br>• Tailwind CSS 주요 스타일링 클래스 사용 <br>• Tailwind 설정 파일 옵션(content, theme, variants, plugins, darkMode, important) |
