...
| `10 week` | Day 21 | 24.09.10 | • MobX 상태 관리 라이브러리 <br>• MobX Store 상태 관리 파일(외부 저장소) <br>• 상태 관찰 설정(makeAutoObservable) <br>• 상태 변화 감지 컴포넌트 리렌더링(observer) <br>• 특정 스토어 컴포넌트 주입(inject) |
